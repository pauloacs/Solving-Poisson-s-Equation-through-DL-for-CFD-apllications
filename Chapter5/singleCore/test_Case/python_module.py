...
def interpolate(values, vtx, wts):
    return np.einsum('nj,nj->n', np.take(values, vtx), wts, optimize=True)
...
def py_func(array_in):
	...
	# If we do not use the try/except the solver will fail with a segmentation faul and tell 
	# absolutly nothing about the error. This is crucial to debugging. 
	try:
		...
		print('This raised the following error:\n')
