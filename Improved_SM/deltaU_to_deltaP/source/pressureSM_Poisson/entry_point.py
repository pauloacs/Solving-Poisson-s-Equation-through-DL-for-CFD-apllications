import argparse
from pressureSM_Poisson.train import main_train
from pressureSM_Poisson.SM_call import call_SM_main
...
def train_entry_point():
    ...
    parser.add_argument('--k', type=float, default=0.5,
                        help='Number of standard deviations to smooth the high variance fields')
...
def eval_entry_point():
    ...
    parser.add_argument('--phis_fn', type=str, default='phis_testRe.txt',
                        help='Path to phis txt file')
