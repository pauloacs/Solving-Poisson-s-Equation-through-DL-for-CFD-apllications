...
def gen_blockMeshDict(x_cord, L, b, alpha, cell_scale, grading):
    ...
    y_cellAB = int((A_cords[1] - B_cords[1]) * cell_scale*20)
    y_cellBD = int((B_cords[1] - D_cords[1]) * cell_scale*20)
    ...
    f.write("    hex (20 19 22 21 4 3 6 5) ({} {} {}) simpleGrading ({} {} 1)\n".format(x_cell, y_cell2 , 1, 1/grading, 1/grading))

    f.write("    hex (19 24 23 22 3 8 7 6) ({} {} {}) simpleGrading ({} {} 1)\n".format(x_cell2, y_cell2, 1, grading, 1/grading))
    ...
    f.write("    hex (29 30 28 27 13 14 12 11) ({} {} {}) simpleGrading ({} {} 1)\n".format( x_cell , y_cell2, 1, 1/grading, grading)) #5

    f.write("    hex  (30 16 31 28 14 0 15 12) ({} {} {}) simpleGrading ({} {} 1)\n".format(x_cell2 , y_cell2, 1, grading, grading))
