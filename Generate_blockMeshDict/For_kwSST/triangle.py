...
def gen_blockMeshDict(x_cord, x_cord2, y_cord,cell_scale):
    """
    Create a `blockMeshDict` file for the geometry
    """
    
    cell_scale = cell_scale
    total_cells_x = 240 * cell_scale
    total_cells_y = 20 * cell_scale
    scale = 1
    z = 0.05
    x_orig = 0
    y_orig = 0
    ...
    x_cord2 = x_cord2
    y_cord = y_cord
    x_cell = int(x_cord2 * cell_scale*20)
    x_cell2 = int((x_cord2 - x_cord) * cell_scale*20)
    y_cell = int(y_cord * cell_scale*20)
    ...
    f.write(");\n"
            ...
            "blocks\n"
            "(\n")
    f.write("    hex (0 1 4 2 8 9 12 10) ({} {} {}) simpleGrading (0.1 1 1)\n".format(x_cell+x_cell2, y_cell, 1))
    f.write("    hex (2 4 7 5 10 12 15 13) ({} {} {}) simpleGrading (0.1 0.1 1)\n".format(x_cell+x_cell2, int(total_cells_y - y_cell), 1))
    #f.write("    hex (3 4 7 6 11 12 15 14) ({} {} {}) simpleGrading (1 1 1)\n".format(x_cell2, 200 - y_cell, 1))
    f.write("    hex (4 16 17 7 12 20 21 15) ({} {} {}) simpleGrading (10 0.1 1)\n".format( int(total_cells_x - x_cell - x_cell2) , int(total_cells_y - y_cell), 1))
    f.write("    hex (18 19 16 4 22 23 20 12) ({} {} {}) simpleGrading (10 1 1)\n".format(int(total_cells_x - x_cell - x_cell2), int(y_cell/2), 1))
...
gen_blockMeshDict(float(args.x_cord), float(args.x_cord2) , float(args.y_cord), float(args.cell_scale) )
