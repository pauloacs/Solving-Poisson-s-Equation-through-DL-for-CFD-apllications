...
def gen_blockMeshDict(x_cord, x_cord2, y_cord, cell_scale, grading):
    ...
    x_cell2 = int((x_cord2 - x_cord) * cell_scale*20 * 2)
    y_cell = int(y_cord * cell_scale*20)

    total_cells_x = x_max * 20 * cell_scale + int(x_cell2*2)
    total_cells_y = y_max * 20 * cell_scale

    y_cell2 = int((total_cells_y - y_cell) )
    ...
    f.write("    hex (2 3 27 25 10 11 26 24) ({} {} {}) simpleGrading (0.1 {} 1)\n".format(x_cell, y_cell2 , 1, grading))
    f.write("    hex (25 27 6 5 24 26 14 13) ({} {} {}) simpleGrading (0.1 {} 1)\n".format(x_cell, y_cell2, 1, 1/grading))
    ...
    f.write("    hex (4 16 31 29 12 20 30 28) ({} {} {}) simpleGrading (10 {} 1)\n".format( x_cell3 , y_cell2, 1, grading))
    f.write("    hex (29 31 17 7 28 30 21 15) ({} {} {}) simpleGrading (10 {} 1)\n".format(x_cell3 , y_cell2, 1, 1/grading))
